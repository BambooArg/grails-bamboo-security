...
class AutoLoginProviderSpec extends Specification {
    ...
    void "test authenticate success"() {
        ...
        autoLoginService.demandExplicit.isValidAuthentication(1){AutoLoginAuthenticationToken autoLoginAuthenticationToken ->
            true
        }
        ...
        autoLoginProvider.autoLoginService = autoLoginService.createMock()
